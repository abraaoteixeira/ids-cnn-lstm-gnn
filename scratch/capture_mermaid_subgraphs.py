...
async def main():
    async with async_playwright() as p:
        ...
        file_path = (project_root / "scratch" / "mermaid_preview_subgraphs.html").as_posix()
        ...
        if brain_dir:
            output_path = (pathlib.Path(brain_dir) / "mermaid_preview_subgraphs.png").as_posix()
        else:
            output_path = (project_root / "artifacts" / "mermaid_preview_subgraphs.png").as_posix()
